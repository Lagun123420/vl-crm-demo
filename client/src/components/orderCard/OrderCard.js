                            ...
                            <div className="card-content white-text">
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <span>{t("Car Odometr")}</span>
                                            </td>
                                            <td>
                                                <span>{order.carOdometr}</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <div className={cl.wrapperTables}>
                ...
                <div className={cl.containerTables}>
                    ...
                    <table id="workTableList">
                        ...
                        <tbody id="workList">
                            {Object.values(order.worksList[0]).map(
                                (workLine, index) => {
                                    return (
                                        <tr>
                    ...
                    <table id="partsTableList">
                        ...
                        <tbody id="partsList">
                            {Object.values(order.partsList[0]).map(
                                (partsLine, index) => {
                                    return (
                                        <tr>
