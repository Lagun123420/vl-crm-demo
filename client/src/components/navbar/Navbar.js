    ...
    return (
        <>
            <nav>
                ...
                >
                    ...
                    <ul id="nav" className="right hide-on-med-and-down">
                        <li>
                            <Link to="/create">{t("Create Client")}</Link>
                        </li>
                        <li>
                            <Link to="/createcar">{t("Create Car")}</Link>
                        </li>
                        <li>
                            <Link to="/createOrder">{t("Create Order")}</Link>
                        </li>
                        <li>
                            <Link to="/clients">{t("Clients List")}</Link>
                        </li>
                        <li>
                            <Link to="/orders">{t("Order List")}</Link>
                        </li>
                        <li>
                            <Link to="/cars">{t("Cars List")}</Link>
                        </li>
                        <li>
                            <Link
                                className={cl.buttonLng}
                                to="#"
            ...
            <ul className="sidenav" id="mobile-demo">
                ...
                <li>
                    <Link to="#" onClick={() => handleLanguageSwitch()}>
                        {i18n.language === "uk" ? "EN" : "UA"}
                    </Link>
                </li>
                <li>
